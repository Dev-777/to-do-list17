import {SURNAME_ONCHANGE, NAME_ONCHANGE, PASSWORD_ONCHANGE, EMAIL_ONCHANGE, REPEAT_PASSWORD_ONCHANGE,  NAME_VALIDATION, SURNAME_VALIDATION, EMAIL_VALIDATION, PASSWORD_VALIDATION, REPEAT_PASSWORD_VALIDATION} from './actions'
